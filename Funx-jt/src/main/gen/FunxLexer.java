...
public class FunxLexer extends Lexer {
	...
	public static final int
		...
		CloseBracket=38, OpenBrace=39, CloseBrace=40, CloseMultiComment=41, OpenMultiComment=42, 
		SingleComment=43;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"END", "FI", "IF", "IN", "LET", "OUT", "THEN", "WITH", "TYPEID", "FUNID", 
			"BOOLEAN", "FLOAT", "INTEGER", "Ampersand", "Backslash", "Bang", "Colon", 
			"Dot", "Equals", "Minus", "Pipe", "Plus", "SemiColon", "Slash", "Star", 
			"UnderScore", "Arrow", "DotArrow", "OpenParen", "CloseParen", "OpenBracket", 
			"CloseBracket", "OpenBrace", "CloseBrace", "CloseMultiComment", "OpenMultiComment", 
			"SingleComment"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OpenBrace", "CloseBrace", "CloseMultiComment", "OpenMultiComment", "SingleComment"
		};
	}
